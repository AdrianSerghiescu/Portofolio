export const PolicyPage = () => {
  return (
    <div
      className="page policy-page"
      style={{ display: "flex", justifyContent: "center", margin: "20px 20%" }}
    >
      <p style={{ color: "white", background: "#000" }}>
        Privacy Policy for Adrian Serghiescu , accessible from https://, one of
        ...
        www.google.com and how we use it. If you have additional questions or
        ...
        that they shared and/or collect in this website. This policy is not
        applicable to any information collected offline or via channels other
        than this website. Our Privacy Policy was created with the help of the
        Free Privacy Policy Generator. Consent By using our website, you hereby
        consent to our Privacy Policy and agree to its terms. Information we
        collect The personal information that you are asked to provide, and the
        ...
        you emails Find and prevent fraud Log Files www.google.com follows a
        ...
        other website, www.google.com uses 'cookies'. These cookies are used to
        ...
        information on cookies, please read the Cookies article on Generate
        Privacy Policy website. Google DoubleClick DART Cookie Google is one of
        a third-party vendor on our site. It also uses cookies, known as DART
        ...
        for each of the advertising partners of www.google.com. Third-party ad
        ...
        that appear on www, which are sent directly to users' browser. They
        ...
        websites that you visit. Note that www has no access to or control over
        these cookies that are used by third-party advertisers. Third Party
        Privacy Policies www.google.com's Privacy Policy does not apply to other
        ...
        guide their online activity. www does not knowingly collect any Personal
